...
const PACK_FILES = ['main.js', 'preload.js', 'signaling.js', 'github.js', 'index.html', 'styles.css', 'renderer/util.js', 'renderer/estado.js', 'renderer/rtc.js', 'renderer/tema.js', 'renderer/sala.js', 'renderer/voz.js', 'renderer/microfone.js', 'renderer.js', 'voice.js', 'encode-once.js', 'pcm-worklet.js', 'bin/audiocap.exe', 'bin/videocap.exe', 'bin/teclas.exe',
